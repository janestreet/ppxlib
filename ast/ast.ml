...
and jkind_const_annotation = string loc
...
and mode_expression = mode_const_expression list loc

and mode_const_expression = string loc
  ...
  object (self)
    ...
    method expression_desc : expression_desc -> expression_desc=
      fun x ->
        ...
        | Pexp_function (a, b, c) ->
            ...
            let b = self#option self#function_constraint b in
    ...
    method function_param_desc : function_param_desc -> function_param_desc=
      fun x ->
        ...
        | Pparam_newtype (a, b) ->
            let a = self#loc self#string a in
            let b = self#option (self#loc self#jkind_annotation) b in
            Pparam_newtype (a, b)
    ...
    method function_constraint : function_constraint -> function_constraint=
      fun { mode_annotations; type_constraint } ->
        let mode_annotations = self#mode_expression mode_annotations in
    ...
    method value_description : value_description -> value_description=
      fun
        ...
        let pval_modalities =
          self#list (self#loc self#modality) pval_modalities in
    ...
    method label_declaration : label_declaration -> label_declaration=
      fun
        ...
        let pld_modalities =
          self#list (self#loc self#modality) pld_modalities in
    ...
    method constructor_argument :
      ...
      fun { pca_modalities; pca_type; pca_loc } ->
        let pca_modalities =
          self#list (self#loc self#modality) pca_modalities in
    ...
    method jkind_const_annotation :
      jkind_const_annotation -> jkind_const_annotation= self#loc self#string
    method jkind_annotation : jkind_annotation -> jkind_annotation=
      fun x ->
        match x with
        | Default -> Default
        | Abbreviation a ->
            let a = self#jkind_const_annotation a in
            Abbreviation a
        | Mod (a, b) ->
            let a = self#jkind_annotation a in
            let b = self#mode_expression b in Mod (a, b)
        | With (a, b) ->
            let a = self#jkind_annotation a in
            let b = self#core_type b in With (a, b)
        | Kind_of a -> let a = self#core_type a in Kind_of a
    method mode_expression : mode_expression -> mode_expression=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression :
      mode_const_expression -> mode_const_expression= self#loc self#string
...
class virtual iter =
  object (self)
      ...
      fun x ->
        ...
        | Pexp_function (a, b, c) ->
            (self#list self#function_param a;
             self#option self#function_constraint b;
      ...
      fun x ->
        ...
        | Pparam_newtype (a, b) ->
            (self#loc self#string a;
             self#option (self#loc self#jkind_annotation) b)
    ...
    method function_constraint : function_constraint -> unit=
      fun { mode_annotations; type_constraint } ->
        self#mode_expression mode_annotations;
    ...
    method value_description : value_description -> unit=
      fun
        ...
        self#list (self#loc self#modality) pval_modalities;
    ...
    method label_declaration : label_declaration -> unit=
      fun
        ...
        self#list (self#loc self#modality) pld_modalities;
    ...
    method constructor_argument : constructor_argument -> unit=
      fun { pca_modalities; pca_type; pca_loc } ->
        self#list (self#loc self#modality) pca_modalities;
    ...
    method jkind_const_annotation : jkind_const_annotation -> unit=
      self#loc self#string
    method jkind_annotation : jkind_annotation -> unit=
      fun x ->
        match x with
        | Default -> ()
        | Abbreviation a -> self#jkind_const_annotation a
        | Mod (a, b) -> (self#jkind_annotation a; self#mode_expression b)
        | With (a, b) -> (self#jkind_annotation a; self#core_type b)
        | Kind_of a -> self#core_type a
    method mode_expression : mode_expression -> unit=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression : mode_const_expression -> unit=
      self#loc self#string
  ...
  object (self)
    ...
    method expression_desc : expression_desc -> 'acc -> 'acc=
      fun x acc ->
        ...
        | Pexp_function (a, b, c) ->
            ...
            let acc = self#option self#function_constraint b acc in
    ...
    method function_param_desc : function_param_desc -> 'acc -> 'acc=
      fun x acc ->
        ...
        | Pparam_newtype (a, b) ->
            let acc = self#loc self#string a acc in
            let acc = self#option (self#loc self#jkind_annotation) b acc in
            acc
    ...
    method function_constraint : function_constraint -> 'acc -> 'acc=
      fun { mode_annotations; type_constraint } acc ->
        let acc = self#mode_expression mode_annotations acc in
        let acc = self#type_constraint type_constraint acc in acc
    method value_description : value_description -> 'acc -> 'acc=
      fun
        ...
        let acc = self#list (self#loc self#modality) pval_modalities acc in
    ...
    method label_declaration : label_declaration -> 'acc -> 'acc=
      fun
        ...
        let acc = self#list (self#loc self#modality) pld_modalities acc in
    ...
    method constructor_argument : constructor_argument -> 'acc -> 'acc=
      fun { pca_modalities; pca_type; pca_loc } acc ->
        let acc = self#list (self#loc self#modality) pca_modalities acc in
    ...
    method jkind_const_annotation : jkind_const_annotation -> 'acc -> 'acc=
      self#loc self#string
    method jkind_annotation : jkind_annotation -> 'acc -> 'acc=
      fun x acc ->
        ...
        | Default -> acc
        | Abbreviation a ->
            self#jkind_const_annotation a acc
        | Mod (a, b) ->
            let acc = self#jkind_annotation a acc in
            let acc = self#mode_expression b acc in acc
        | With (a, b) ->
            let acc = self#jkind_annotation a acc in
            let acc = self#core_type b acc in acc
        | Kind_of a -> self#core_type a acc
    method mode_expression : mode_expression -> 'acc -> 'acc=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression : mode_const_expression -> 'acc -> 'acc=
      self#loc self#string
  ...
  object (self)
    ...
    method expression_desc :
      ...
      fun x acc ->
        ...
        | Pexp_function (a, b, c) ->
            ...
            let (b, acc) = self#option self#function_constraint b acc in
    ...
    method function_param_desc :
      ...
      fun x acc ->
        ...
        | Pparam_newtype (a, b) ->
            let (a, acc) = self#loc self#string a acc in
            let (b, acc) = self#option (self#loc self#jkind_annotation) b acc in
    ...
    method function_constraint :
      ...
      fun { mode_annotations; type_constraint } acc ->
        let (mode_annotations, acc) =
          self#mode_expression mode_annotations acc in
    ...
    method value_description :
      ...
      fun
        ...
        let (pval_modalities, acc) =
          self#list (self#loc self#modality) pval_modalities acc in
    ...
    method label_declaration :
      ...
      fun
        ...
        let (pld_modalities, acc) =
          self#list (self#loc self#modality) pld_modalities acc in
    ...
    method constructor_argument :
      ...
      fun { pca_modalities; pca_type; pca_loc } acc ->
        let (pca_modalities, acc) =
          self#list (self#loc self#modality) pca_modalities acc in
    ...
    method jkind_const_annotation :
      jkind_const_annotation -> 'acc -> (jkind_const_annotation * 'acc)=
      self#loc self#string
    method jkind_annotation :
      ...
      fun x acc ->
        ...
        | Default -> (Default, acc)
        | Abbreviation a ->
            let (a, acc) = self#jkind_const_annotation a acc in
            ((Abbreviation a), acc)
        | Mod (a, b) ->
            let (a, acc) = self#jkind_annotation a acc in
            let (b, acc) = self#mode_expression b acc in ((Mod (a, b)), acc)
        | With (a, b) ->
            let (a, acc) = self#jkind_annotation a acc in
            let (b, acc) = self#core_type b acc in ((With (a, b)), acc)
        | Kind_of a ->
            let (a, acc) = self#core_type a acc in ((Kind_of a), acc)
    method mode_expression :
      mode_expression -> 'acc -> (mode_expression * 'acc)=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression :
      mode_const_expression -> 'acc -> (mode_const_expression * 'acc)=
      self#loc self#string
  ...
  object (self)
    ...
    method expression_desc : 'ctx -> expression_desc -> expression_desc=
      fun ctx x ->
        ...
        | Pexp_function (a, b, c) ->
            ...
            let b = self#option self#function_constraint ctx b in
    ...
    method function_param_desc :
      ...
      fun ctx x ->
        ...
        | Pparam_newtype (a, b) ->
            let a = self#loc self#string ctx a in
            let b = self#option (self#loc self#jkind_annotation) ctx b in
            Pparam_newtype (a, b)
    ...
    method function_constraint :
      ...
      fun ctx { mode_annotations; type_constraint } ->
        let mode_annotations = self#mode_expression ctx mode_annotations in
    ...
    method value_description :
      ...
      fun ctx
        ...
        let pval_modalities =
          self#list (self#loc self#modality) ctx pval_modalities in
    ...
    method label_declaration :
      ...
      fun ctx
        ...
        let pld_modalities =
          self#list (self#loc self#modality) ctx pld_modalities in
    ...
    method constructor_argument :
      ...
      fun ctx { pca_modalities; pca_type; pca_loc } ->
        let pca_modalities =
          self#list (self#loc self#modality) ctx pca_modalities in
    ...
    method module_binding : 'ctx -> module_binding -> module_binding=
      fun ctx { pmb_name; pmb_expr; pmb_attributes; pmb_loc } ->
        ...
        { pmb_name; pmb_expr; pmb_attributes; pmb_loc }
    method jkind_const_annotation :
      'ctx -> jkind_const_annotation -> jkind_const_annotation=
      self#loc self#string
    method jkind_annotation : 'ctx -> jkind_annotation -> jkind_annotation=
      fun ctx x ->
        ...
        | Default -> Default
        | Abbreviation a ->
            let a = self#jkind_const_annotation ctx a in
            Abbreviation a
        | Mod (a, b) ->
            let a = self#jkind_annotation ctx a in
            let b = self#mode_expression ctx b in Mod (a, b)
        | With (a, b) ->
            let a = self#jkind_annotation ctx a in
            let b = self#core_type ctx b in With (a, b)
        | Kind_of a -> let a = self#core_type ctx a in Kind_of a
    method mode_expression : 'ctx -> mode_expression -> mode_expression=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression :
      'ctx -> mode_const_expression -> mode_const_expression=
      self#loc self#string
  ...
  object (self)
    ...
    method module_binding : module_binding -> 'res=
      fun { pmb_name; pmb_expr; pmb_attributes; pmb_loc } ->
        ...
        self#record
          ...
          ("pmb_loc", pmb_loc)]
    method jkind_const_annotation : jkind_const_annotation -> 'res=
      self#loc self#string
    method jkind_annotation : jkind_annotation -> 'res=
      fun x ->
        ...
        | Mod (a, b) ->
            let a = self#jkind_annotation a in
            let b = self#mode_expression b in self#constr "Mod" [a; b]
        | With (a, b) ->
            let a = self#jkind_annotation a in
            let b = self#core_type b in self#constr "With" [a; b]
        | Kind_of a -> let a = self#core_type a in self#constr "Kind_of" [a]
    method mode_expression : mode_expression -> 'res=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression : mode_const_expression -> 'res=
      self#loc self#string
...
class virtual ['ctx,'res] lift_map_with_context =
  object (self)
    ...
    method jkind_const_annotation :
      'ctx -> jkind_const_annotation -> (jkind_const_annotation * 'res)=
      self#loc self#string
    method jkind_annotation :
      ...
      fun ctx x ->
        ...
        | Abbreviation a ->
            ...
            ((Abbreviation (Stdlib.fst a)),
              (self#constr ctx "Abbreviation"
                 [Stdlib.snd a]))
        | Mod (a, b) ->
            let a = self#jkind_annotation ctx a in
            let b = self#mode_expression ctx b in
    ...
    method mode_expression :
      'ctx -> mode_expression -> (mode_expression * 'res)=
      self#loc (self#list self#mode_const_expression)
    method mode_const_expression :
      'ctx -> mode_const_expression -> (mode_const_expression * 'res)=
      self#loc self#string
    method toplevel_phrase :
