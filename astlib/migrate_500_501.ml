...
and copy_expression_desc :
  ...
  | Ast_500.Parsetree.Pexp_function (x0, x1, x2) ->
      Ast_501.Parsetree.Pexp_function
...
and copy_function_param :
  Ast_500.Parsetree.function_param -> Ast_501.Parsetree.function_param =
...
and copy_function_param_desc :
  Ast_500.Parsetree.function_param_desc -> Ast_501.Parsetree.function_param_desc =
  function
...
and copy_function_constraint :
  Ast_500.Parsetree.function_constraint -> Ast_501.Parsetree.function_constraint =
...
and copy_type_constraint :
  Ast_500.Parsetree.type_constraint -> Ast_501.Parsetree.type_constraint =
  function
...
and copy_function_body :
  Ast_500.Parsetree.function_body -> Ast_501.Parsetree.function_body =
  function
...
and copy_jkind_annotation :
  Ast_500.Parsetree.jkind_annotation -> Ast_501.Parsetree.jkind_annotation =
  function
  | Default -> Default
...
and copy_constructor_argument :
  ...
  fun {
    ...
    {
      Ast_501.Parsetree.pca_modalities = List.map (copy_loc copy_modality) pca_modalities;
      Ast_501.Parsetree.pca_type = copy_core_type pca_type;
      Ast_501.Parsetree.pca_loc = copy_location pca_loc;
    }
...
and copy_constructor_arguments :
  ...
  | Ast_500.Parsetree.Pcstr_tuple x0 ->
      Ast_501.Parsetree.Pcstr_tuple (List.map copy_constructor_argument x0)
...
and copy_label_declaration :
 ...
 fun {
     ...
     } ->
  {
    ...
    Ast_501.Parsetree.pld_modalities = List.map (copy_loc copy_modality) pld_modalities;
...
and copy_modality :
  ...
  function
  | Ast_500.Parsetree.Modality m -> Ast_501.Parsetree.Modality m
